...
const TaxiDashboard = () => {
  ...
  const [cashForm, setCashForm] = useState({ amount: "", name: "", phone: "", notes: "" })
  ...
  return (
    <DashboardShell title="Taxi Console" subtitle="Daily cash, expenses, insights" hideShellChrome>
      ...
      <nav className="sys-nav" aria-label="Taxi sections">
        {[
      ...
      {activeTab === "cash" ? (
        <section className="card">
          ...
          <h4 style={{ marginTop: 16 }}>Recent Collections (today)</h4>
